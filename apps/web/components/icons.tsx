...
export const Icons = {
  ...
  spinner: (props: IconProps) => (
    ...
    >
      ...
      <circle cx="25" cy="40" r="2" fill="currentColor" opacity=".3"></circle>
      <circle cx="32.5" cy="12" r="2" fill="currentColor" opacity=".3"></circle>
      <circle cx="17.5" cy="38" r="2" fill="currentColor" opacity=".3"></circle>
      <circle
        cx="17.5"
        cy="12"
        r="2"
        ...
        opacity=".93"
      ></circle>
      <circle cx="32.5" cy="38" r="2" fill="currentColor" opacity=".3"></circle>
      <circle cx="10" cy="25" r="2" fill="currentColor" opacity=".65"></circle>
      <circle cx="40" cy="25" r="2" fill="currentColor" opacity=".3"></circle>
      <circle
        cx="12"
        cy="17.5"
        r="2"
        ...
        opacity=".86"
      ></circle>
      <circle cx="38" cy="32.5" r="2" fill="currentColor" opacity=".3"></circle>
      <circle
        cx="12"
        cy="32.5"
        r="2"
        ...
        opacity=".44"
      ></circle>
      <circle cx="38" cy="17.5" r="2" fill="currentColor" opacity=".3"></circle>
    </svg>
  ),
}
